...
export function Nav() {
      ...
      <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
        ...
        <div className="flex flex-col">
          ...
          >
            ...
            <Link to={"/produits"} className="flex items-center text-gray-500">
              Stocks
            </Link>
          </Typography>
        </div>
        <div className="flex flex-col">
          ...
          >
            ...
            <Link to={"/employees"} className="flex items-center text-gray-500">
              Employées
            </Link>
          </Typography>
        </div>
        <div className="flex flex-col">
          ...
          >
            ...
            <Link to={"/docs"} className="flex items-center  text-gray-500">
              Docs
            </Link>
          </Typography>
        </div>
        <div className="flex flex-col">
          ...
          >
            ...
            <Link to={"/contact"} className="flex items-center  text-gray-500">
              Contact
            </Link>
          </Typography>
        </div>
  ...
  return (
<Navbar className="fixed top-0 left-0 right-0 mx-auto w-full z-50 bg-white shadow-md">
  <div className="container mx-auto flex items-center justify-between text-blue-gray-900 max-w-screen-xl px-4 py-2 lg:px-1 lg:py-1">
    <Typography
      as="a"
      href="/"
      className="mr-4 cursor-pointer py-1.5 font-medium text-gray-700"
    >
      SchoolGear Express
    </Typography>
    ...
    <IconButton
      variant="text"
      className="ml-auto h-6 w-6 text-inherit hover:bg-transparent focus:bg-transparent active:bg-transparent lg:hidden text-gray-700"
      ripple={false}
