    ...
    <Menu open={isMenuOpen} handler={setIsMenuOpen} placement="bottom-end">
      <MenuHandler>
        ...
        >
          ...
          <ChevronDownIcon
            strokeWidth={2.5}
            className={`h-3 text-black w-3 transition-transform ${
              isMenuOpen ? "rotate-180" : ""
            }`}
          />
        </Button>
      </MenuHandler>
      <MenuList className="p-1 text-black">
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <MenuList className="hidden w-[36rem] text-black grid-cols-7 gap-3 overflow-visible lg:grid">
          <Card
            color="blue"
            shadow={false}
            variant="gradient"
            className="col-span-3 grid text-black h-full w-full place-items-center rounded-md"
          >
